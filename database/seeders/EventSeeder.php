...
class EventSeeder extends Seeder
{
    public function run(): void
    {
        $events = [
            [
                'name' => 'Kuliah Umum: Tren Cybersecurity Terkini di Era AI',
                'slug' => 'kuliah-umum-cybersecurity-era-ai',
                'type' => 'seminar',
                'start_datetime' => '2026-08-10 09:00:00',
                'end_datetime' => '2026-08-10 12:00:00',
                'location' => 'Aula Barat ITB & Zoom Meeting',
                'description' => 'Kuliah umum bersama narasumber dari BSSN dan praktisi keamanan teknologi global yang membahas tantangan proteksi data pribadi terhadap serangan berbasis AI.',
            ...
            [
                'name' => 'Workshop: Hands-on Development on 5G Micro-controllers',
                'slug' => 'workshop-hands-on-5g-microcontrollers',
                'type' => 'workshop',
                'start_datetime' => '2026-07-25 13:00:00',
                'end_datetime' => '2026-07-25 17:00:00',
                'location' => 'Laboratorium Komputer STEI ITB Gedung Benny Subianto',
                'description' => 'Pelatihan intensif pengembangan pemrograman mikrokontroler berbasis modul transmisi data 5G secara real-time.',
            ...
            [
                'name' => 'Sidang Pleno & Pelepasan Wisuda STEI ITB Periode Juli 2026',
                'slug' => 'pelepasan-wisuda-stei-juli-2026',
                'type' => 'graduation',
                'start_datetime' => '2026-07-18 08:00:00',
                'end_datetime' => '2026-07-18 11:30:00',
                'location' => 'Gedung Serba Guna ITB (GSG)',
                'description' => 'Acara seremonial pelepasan wisudawan program Sarjana, Magister, dan Doktor STEI ITB periode wisuda kedua tahun akademik 2025/2026.',
