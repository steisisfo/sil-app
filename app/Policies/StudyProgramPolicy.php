...
class StudyProgramPolicy
{
    ...
    {
        return $user->can(PermissionType::MANAGE_STUDY_PROGRAMS->value);
    }
     ...
     */
    public function restore(User $user, StudyProgram $model): bool
    {
        return $user->can(PermissionType::MANAGE_STUDY_PROGRAMS->value);
    }
     ...
     */
    public function forceDelete(User $user, StudyProgram $model): bool
    {
        return $user->can(PermissionType::MANAGE_STUDY_PROGRAMS->value);
    }
}
